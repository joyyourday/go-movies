...
function EightAMMetro({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/8AMMetro-2023/8AMMetro",
        },
        {
          "@type": "EntryPoint",
          name: "8 A M Metro (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/8AMMetro-2023/AMMSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch 8 A M Metro (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch 8 A M Metro (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/8AMMetro-2023/8AMMetro"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch 8 A M Metro Full Movie Online on Go Movies™, You can also download 8 A M Metro (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/8AMMetro-2023/EightAMMetro"
        />
      </Head>
