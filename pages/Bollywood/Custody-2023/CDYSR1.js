      ...
      target: [
        {
          ...
          name: "Custody (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/Custody-2023/Custody",
        },
        {
          "@type": "EntryPoint",
          name: "Custody (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/Custody-2023/CDYSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="Go Movies,custody movie,custody 2023,index of custody movie,custody cast,custody trailer,custody release date,custody plot,custody reviews,custody streaming,custody watch online,custody download,custody full movie,custody movie download,custody movie free download,custody movie online,custody movie watch online"
        />
        ...
        <meta
          property="og:title"
          content="Watch Custody (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/Custody-2023/Custody"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download Custody (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/Custody-2023/CDYSR1"
        />
      </Head>
