...
function SoppanaSundari({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/SoppanaSundari-2023/SoppanaSundari",
        },
        {
          "@type": "EntryPoint",
          name: "Soppana Sundari (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/SoppanaSundari-2023/SODSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Soppana Sundari (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Soppana Sundari (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/SoppanaSundari-2023/SoppanaSundari"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Soppana Sundari Full Movie Online on Go Movies™, You can also download Soppana Sundari (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/SoppanaSundari-2023/SoppanaSundari"
        />
      </Head>
