...
function RamaBanam({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/RamaBanam-2023/RamaBanam",
        },
        {
          "@type": "EntryPoint",
          name: "Rama Banam (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/RamaBanam-2023/RAMSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Rama Banam (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="Go Movies,rama banam movie,rama banam 2023,index of rama banam movie,rama banam cast,rama banam trailer,rama banam release date,rama banam plot,rama banam reviews,rama banam streaming,rama banam watch online,rama banam download,rama banam full movie,rama banam movie download,rama banam movie free download,rama banam movie online,rama banam movie watch online,adah sharma, yogita bihani in rama banam"
        />
        ...
        <meta
          property="og:title"
          content="Watch Rama Banam (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/RamaBanam-2023/RamaBanam"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Rama Banam Full Movie Online on Go Movies™, You can also download Rama Banam (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/RamaBanam-2023/RamaBanam"
        />
      </Head>
