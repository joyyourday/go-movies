  ...
  const ldJsonData = JSON.stringify({
    ...
    Part: [
      {
        "@type": "TVPart",
        name: "Dahaad Part 1",
        url: "https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP1",
      },
      {
        "@type": "TVPart",
        name: "Dahaad Part 2",
        url: "https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP2",
      },
      {
        "@type": "TVPart",
        name: "Dahaad Part 3",
        url: "https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP3",
      },
    ],
    author: [
      {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate:
          "https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP1",
      },
    },
    additionalProperty: {
      "@type": "PropertyValue",
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="Go Movies,dahaad tv series,dahaad 2023,index of dahaad tv series,dahaad cast,dahaad trailer,dahaad release date,dahaad plot,dahaad reviews,dahaad streaming,dahaad watch online,dahaad download,dahaad full Parts,dahaad tv series download,dahaad tv series free download,dahaad tv series online,dahaad tv series watch online"
        />
        ...
        <meta property="og:title" content="Watch Dahaad (2023) | Go Movies™" />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP1"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Watch Dahaad (2023) | Go Movies™"
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1683907527/Dahaad-S01-2023_icbq9u.webp"
        ...
        <meta
          name="description"
          content="Watch Dahaad Full Movie Online on Go Movies™, You can also download Dahaad (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/Dahaad-2023/DahaadP2"
        />
      </Head>
