...
function ChorNikalKeBhaga({ movie }) {
      ...
      target: [
        {
          ...
          name: "Gaslight (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/ChorNikalKeBhaga-2023/ChorNikalKeBhaga",
        },
        {
          "@type": "EntryPoint",
          name: "Gaslight (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/ChorNikalKeBhaga-2023/CNBSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Chor Nikal Ke Bhaga Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Chor Nikal Ke Bhaga | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/ChorNikalKeBhaga-2023/ChorNikalKeBhaga"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Chor Nikal KeBhaga Full Movie Online on Go Movies™, You can also download Chor Nikal Ke Bhaga in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/ChorNikalKeBhaga-2023/ChorNikalKeBhaga"
        />
      </Head>
