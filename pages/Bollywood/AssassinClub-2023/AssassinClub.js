...
function AssassinClub({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/AssassinClub-2023/AssassinClub",
        },
        {
          "@type": "EntryPoint",
          name: "Assassin Club (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Bollywood/AssassinClub-2023/ASCSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Assassin Club (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Assassin Club (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Bollywood/AssassinClub-2023/AssassinClub"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch AssassinClub Full Movie Online on Go Movies™, You can also download Assassin Club (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Bollywood/AssassinClub-2023/AssassinClub"
        />
      </Head>
