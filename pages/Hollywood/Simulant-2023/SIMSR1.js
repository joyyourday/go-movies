...
function SIMSR1({ movie }) {
      ...
      target: [
        {
          ...
          name: "Simulant (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Simulant-2023/Simulant",
        },
        {
          "@type": "EntryPoint",
          name: "Simulant (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Simulant-2023/SIMSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Simulant (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Simulant (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/Simulant-2023/Simulant"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download Simulant (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/Simulant-2023/SIMSR1"
        />
      </Head>
