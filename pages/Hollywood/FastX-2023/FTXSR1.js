      ...
      target: [
        {
          ...
          name: "Fast X (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/FastX-2023/FastX",
        },
        {
          "@type": "EntryPoint",
          name: "Fast X (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/FastX-2023/FTXSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/FastX-2023/FastX"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Watch Fast X (2023) | Go Movies™"
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1684696475/fast-x-2023_ljbfkt.webp"
        ...
        <meta
          name="description"
          content="Watch Fast X Full Movie Online on Go Movies™, You can also download Fast X (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/FastX-2023/FTXSR1"
        />
      </Head>
