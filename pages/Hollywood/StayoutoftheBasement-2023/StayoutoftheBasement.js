      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/StayoutoftheBasement-2023/StayoutoftheBasement",
        },
        {
          "@type": "EntryPoint",
          name: "Stay out of the Basement (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/StayoutoftheBasement-2023/SOBSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content="Watch Stay out of the Basement (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/StayoutoftheBasement-2023/StayoutoftheBasement"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch StayoutoftheBasement Full Movie Online on Go Movies™, You can also download Stay out of the Basement (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/StayoutoftheBasement-2023/StayoutoftheBasement"
        />
      </Head>
