...
function TMTSR1({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/TheMother-2023/TheMother",
        },
        {
          "@type": "EntryPoint",
          name: "The Mother (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/TheMother-2023/TMTSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch The Mother (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="Go Movies,the mother movie,the mother 2023,index of the mother movie,the mother cast,the mother trailer,the mother release date,the mother plot,the mother reviews,the mother streaming,the mother watch online,the mother download,the mother full movie,the mother movie download,the mother movie free download,the mother movie online,the mother movie watch online,jennifer lopez, lucy paez in the mother"
        />
        ...
        <meta
          property="og:title"
          content="Watch The Mother (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/TheMother-2023/TheMother"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download The Mother (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/TheMother-2023/TMTSR1"
        />
      </Head>
