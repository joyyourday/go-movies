...
function ANurseToDieFor({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/ANurseToDieFor-2023/ANurseToDieFor",
        },
        {
          "@type": "EntryPoint",
          name: "A Nurse To Die For (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/ANurseToDieFor-2023/NTDSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch A Nurse To Die For (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="Go Movies,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch a nurse to die for movie,index of a nurse to die for movie,a nurse to die for movie 2023,a nurse to die for movie online,watch a nurse to die for movie online free,a nurse to die for tv series,a nurse to die for movie download,a nurse to die for movie free download,a nurse to die for movie download"
        />
        ...
        <meta
          property="og:title"
          content="Watch A Nurse To Die For (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/ANurseToDieFor-2023/ANurseToDieFor"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch a nurse to die for Full Movie Online on Go Movies™, You can also download A Nurse To Die For (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/ANurseToDieFor-2023/ANurseToDieFor"
        />
      </Head>
