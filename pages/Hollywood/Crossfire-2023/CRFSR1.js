...
function CRFSR1({ movie }) {
      ...
      target: [
        {
          ...
          name: "Crossfire (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Crossfire-2023/Crossfire",
        },
        {
          "@type": "EntryPoint",
          name: "Crossfire (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Crossfire-2023/CRFSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Crossfire (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Crossfire (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/Crossfire-2023/Crossfire"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download Crossfire (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/Crossfire-2023/CRFSR1"
        />
      </Head>
