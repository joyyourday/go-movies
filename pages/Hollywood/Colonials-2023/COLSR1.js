...
function COLSR1({ movie }) {
      ...
      target: [
        {
          ...
          name: "Colonials (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Colonials-2023/Colonials",
        },
        {
          "@type": "EntryPoint",
          name: "Colonials (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/Colonials-2023/COLSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Colonials (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="Go Movies,colonials movie,colonials 2023,index of colonials movie,colonials cast,colonials trailer,colonials release date,colonials plot,colonials reviews,colonials streaming,colonials watch online,colonials download,colonials full movie,colonials movie download,colonials movie free download,colonials movie online,colonials movie watch online"
        />
        ...
        <meta
          property="og:title"
          content="Watch Colonials (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/Colonials-2023/Colonials"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download Colonials (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/Colonials-2023/COLSR1"
        />
      </Head>
