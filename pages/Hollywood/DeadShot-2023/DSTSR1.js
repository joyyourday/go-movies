...
function DSTSR1({ movie }) {
      ...
      target: [
        {
          ...
          name: "Dead Shot (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/DeadShot-2023/DeadShot",
        },
        {
          "@type": "EntryPoint",
          name: "Dead Shot (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/DeadShot-2023/DSTSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Dead Shot (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Dead Shot (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/DeadShot-2023/DeadShot"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download Dead Shot (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/DeadShot-2023/DSTSR1"
        />
      </Head>
