...
function ODLSR1({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/OneDayAsALion-2023/OneDayAsALion",
        },
        {
          "@type": "EntryPoint",
          name: "One Day As A Lion (2023)",
          urlTemplate:
            "https://gomovies.netlify.app/Hollywood/OneDayAsALion-2023/ODLSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch One Day As A Lion (2023) Full Movie Online Free | Go Movies™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch One Day As A Lion (2023) | Go Movies™"
        />
        <meta
          property="og:url"
          content="https://gomovies.netlify.app/Hollywood/OneDayAsALion-2023/OneDayAsALion"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch One Day As A Lion Full Movie Online on Go Movies™, You can also download One Day As A Lion (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://gomovies.netlify.app/Hollywood/OneDayAsALion-2023/ODLSR1"
        />
      </Head>
